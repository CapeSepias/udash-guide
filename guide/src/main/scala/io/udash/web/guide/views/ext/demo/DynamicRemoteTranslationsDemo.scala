...
object DynamicRemoteTranslationsDemo {
  ...
  def apply(): dom.Element = {
    ...
    div(id := "dynamic-rpc-translations-demo", GuideStyles.frame)(
      button(BootstrapStyles.Button.btn, BootstrapStyles.Button.btnPrimary)(onclick := ((_: Event) => lang.set(Lang("en"))))("EN"), " ",
      button(BootstrapStyles.Button.btn, BootstrapStyles.Button.btnPrimary)(onclick := ((_: Event) => lang.set(Lang("pl"))))("PL"),
      ul(
